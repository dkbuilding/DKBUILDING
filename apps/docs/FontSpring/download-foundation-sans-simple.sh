...
# Script de téléchargement simple et efficace des 24 variantes Foundation Sans
...
DOWNLOAD_DIR="$PROJECT_ROOT/_downloads/foundation-sans-simple"

echo "🚀 Téléchargement simple des 24 variantes Foundation Sans"
echo "========================================================="
...
# Fonction principale
main() {
    echo "🚀 Démarrage du téléchargement simple..."
    ...
    echo ""
    echo "📊 Résumé du téléchargement simple:"
    echo "=================================="
...
echo ""
echo "✨ Téléchargement simple terminé!"
echo "================================="
