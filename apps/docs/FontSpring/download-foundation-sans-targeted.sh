...
# Script de téléchargement ciblé des 24 variantes Foundation Sans
# Utilise des méthodes spécifiques et des URLs connues
...
DOWNLOAD_DIR="$PROJECT_ROOT/_downloads/foundation-sans-targeted"

echo "🎯 Téléchargement ciblé des 24 variantes Foundation Sans"
echo "========================================================"
...
download_foundation_sans_variants() {
    echo "🔍 Téléchargement des variantes Foundation Sans..."
    
    # URLs de téléchargement direct (patterns probables)
    local download_urls=(
        # Ultra Light
    ...
    local total_count=${#download_urls[@]}
...
# Fonction principale
main() {
    echo "🚀 Démarrage du téléchargement ciblé..."
    
    # Étape 1: Téléchargement direct avec URLs ciblées
    ...
    echo ""
    echo "📊 Résumé du téléchargement ciblé:"
    echo "================================="
...
echo ""
echo "✨ Téléchargement ciblé terminé!"
echo "================================"
